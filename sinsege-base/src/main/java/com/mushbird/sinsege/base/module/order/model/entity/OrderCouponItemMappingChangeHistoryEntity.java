...
public abstract class OrderCouponItemMappingChangeHistoryEntity extends BaseEntity implements Serializable {
    private Integer ordCpnItemMapChistId;
    ...
    public Integer getOrdCpnItemMapChistId() {
        return ordCpnItemMapChistId;
    }

    public void setOrdCpnItemMapChistId(Integer ordCpnItemMapChistId) {
        this.ordCpnItemMapChistId = ordCpnItemMapChistId;
    }
    ...
    public String toString() {
        ...
        sb.append(", ordCpnItemMapChistId=").append(ordCpnItemMapChistId);
    ...
    public boolean equals(Object that) {
        ...
        OrderCouponItemMappingChangeHistoryEntity other = (OrderCouponItemMappingChangeHistoryEntity) that;
        return (this.getOrdCpnItemMapChistId() == null ? other.getOrdCpnItemMapChistId() == null : this.getOrdCpnItemMapChistId().equals(other.getOrdCpnItemMapChistId()))
            && (this.getOrdCpnItemMapId() == null ? other.getOrdCpnItemMapId() == null : this.getOrdCpnItemMapId().equals(other.getOrdCpnItemMapId()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getOrdCpnItemMapChistId() == null) ? 0 : getOrdCpnItemMapChistId().hashCode());
