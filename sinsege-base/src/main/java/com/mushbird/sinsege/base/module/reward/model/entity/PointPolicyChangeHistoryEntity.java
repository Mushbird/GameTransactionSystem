...
public abstract class PointPolicyChangeHistoryEntity extends BaseEntity implements Serializable {
    private Integer ptPcyChistId;
    ...
    public Integer getPtPcyChistId() {
        return ptPcyChistId;
    }

    public void setPtPcyChistId(Integer ptPcyChistId) {
        this.ptPcyChistId = ptPcyChistId;
    }
    ...
    public String toString() {
        ...
        sb.append(", ptPcyChistId=").append(ptPcyChistId);
    ...
    public boolean equals(Object that) {
        ...
        PointPolicyChangeHistoryEntity other = (PointPolicyChangeHistoryEntity) that;
        return (this.getPtPcyChistId() == null ? other.getPtPcyChistId() == null : this.getPtPcyChistId().equals(other.getPtPcyChistId()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getPtPcyChistId() == null) ? 0 : getPtPcyChistId().hashCode());
