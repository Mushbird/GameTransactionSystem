...
public abstract class OrderClaimEntity extends BaseEntity implements Serializable {
    ...
    private String clmRcptChCd;

    private String clmRcptEnvCd;
    ...
    public String getClmRcptChCd() {
        return clmRcptChCd;
    }

    public void setClmRcptChCd(String clmRcptChCd) {
        this.clmRcptChCd = clmRcptChCd == null ? null : clmRcptChCd.trim();
    }

    public String getClmRcptEnvCd() {
        return clmRcptEnvCd;
    }

    public void setClmRcptEnvCd(String clmRcptEnvCd) {
        this.clmRcptEnvCd = clmRcptEnvCd == null ? null : clmRcptEnvCd.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", clmRcptChCd=").append(clmRcptChCd);
        sb.append(", clmRcptEnvCd=").append(clmRcptEnvCd);
    ...
    public boolean equals(Object that) {
        ...
        OrderClaimEntity other = (OrderClaimEntity) that;
        return (this.getOrdClmId() == null ? other.getOrdClmId() == null : this.getOrdClmId().equals(other.getOrdClmId()))
            ...
            && (this.getClmRcptChCd() == null ? other.getClmRcptChCd() == null : this.getClmRcptChCd().equals(other.getClmRcptChCd()))
            && (this.getClmRcptEnvCd() == null ? other.getClmRcptEnvCd() == null : this.getClmRcptEnvCd().equals(other.getClmRcptEnvCd()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getClmRcptChCd() == null) ? 0 : getClmRcptChCd().hashCode());
        result = prime * result + ((getClmRcptEnvCd() == null) ? 0 : getClmRcptEnvCd().hashCode());
