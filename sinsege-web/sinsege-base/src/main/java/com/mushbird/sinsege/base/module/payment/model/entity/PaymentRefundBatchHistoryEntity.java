...
public abstract class PaymentRefundBatchHistoryEntity extends BaseEntity implements Serializable {
    private Integer payRfdBatchHistId;
    ...
    public Integer getPayRfdBatchHistId() {
        return payRfdBatchHistId;
    }

    public void setPayRfdBatchHistId(Integer payRfdBatchHistId) {
        this.payRfdBatchHistId = payRfdBatchHistId;
    }
    ...
    public String toString() {
        ...
        sb.append(", payRfdBatchHistId=").append(payRfdBatchHistId);
    ...
    public boolean equals(Object that) {
        ...
        PaymentRefundBatchHistoryEntity other = (PaymentRefundBatchHistoryEntity) that;
        return (this.getPayRfdBatchHistId() == null ? other.getPayRfdBatchHistId() == null : this.getPayRfdBatchHistId().equals(other.getPayRfdBatchHistId()))
            && (this.getPayRfdBatchQueId() == null ? other.getPayRfdBatchQueId() == null : this.getPayRfdBatchQueId().equals(other.getPayRfdBatchQueId()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getPayRfdBatchHistId() == null) ? 0 : getPayRfdBatchHistId().hashCode());
