...
public abstract class OrderCouponEntity extends BaseEntity implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        OrderCouponEntity other = (OrderCouponEntity) that;
        return (this.getOrdCpnId() == null ? other.getOrdCpnId() == null : this.getOrdCpnId().equals(other.getOrdCpnId()))
